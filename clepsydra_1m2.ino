...
// uncomment first time next 2 lines, upload sketch, comment lines and upload again...
//EEPROM.write(100,1); 
//EEPROM.write(101,0); 

timp = EEPROM.read(100);
numaratoare = EEPROM.read(101);
}
...
for(int i = cicluri ; i >0  ; i--)
{
     displayNumber1(numaratoare); // this is number to diplay
